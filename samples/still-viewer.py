...
class StillViewer(SampleBase):
    def __init__(self, *args, **kwargs):
        ...
        self.parser.add_argument("-i", "--image", help="Image Location or URL", default="images/raspberry.ppm")
    
    def run(self):
        while True:
            sysArg = self.args.image
            ### Removing the ability to retrieve remote images from original sample ###
            #   Avoids needing urllib as a dependency and not necessary for testing
            #
